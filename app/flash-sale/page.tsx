  ...
  return (
    <div className="min-h-screen bg-minsah-light pb-20">
      ...
      <div className="px-4 py-4 bg-white">
        <h1 className="text-2xl font-bold text-minsah-dark">Sale Products</h1>
      </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          {products.map((product) => (
            <div key={product.id} className="bg-white rounded-2xl p-4 shadow-sm relative">
              {/* Discount Badge */}
              {product.discount > 0 && (
                <div className="absolute top-6 left-6 bg-red-500 text-white text-xs font-bold px-2 py-1 rounded z-10">
      ...
      <nav className="fixed bottom-0 left-0 right-0 bg-white border-t border-minsah-accent shadow-lg z-50">
        <div className="flex items-center justify-around py-3">
          ...
          <Link href="/wishlist" className="flex flex-col items-center gap-1 text-minsah-primary">
            <Heart size={24} />
